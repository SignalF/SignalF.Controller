...
{
	public partial class GpioPinValue : BusinessAttribute, SignalF.Datamodel.Hardware.IGpioPinValue
	{
		...
		EGpioPinValue IGpioPinValue.Value
		{
			get
			{
				try
				{
					...
					if(val.Length == 0)
						return new EGpioPinValue();

					return (EGpioPinValue)System.Enum.Parse(typeof(EGpioPinValue), val);
				}
		...
		EGpioPinValue IGpioPinValue.DefaultValue
		{
			get
			{
				try
		...
		public override object Value
		{
			get
			{
				try
				{
					return  ((IGpioPinValue)this).Value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
			...
			set
			{
				try
				{
					((IGpioPinValue)this).Value = (EGpioPinValue)value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		public override object DefaultValue
		{
			get
			{
				try
				{
					return  ((IGpioPinValue)this).DefaultValue;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		bool IGpioPinValue.Validate(EGpioPinValue value)
		{
			try
			{
		...
		public override bool Validate(object value)
		{
			try
			{
				return ((IGpioPinValue)this).Validate((EGpioPinValue)value);
			}
			catch(Scotec.XMLDatabase.DataException e)
			{
				throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
