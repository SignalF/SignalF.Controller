...
{
	public partial class I2cBusSpeed : BusinessAttribute, SignalF.Datamodel.Hardware.II2cBusSpeed
	{
		...
		EI2cBusSpeed II2cBusSpeed.Value
		{
			get
			{
				try
				{
					...
					if(val.Length == 0)
						return new EI2cBusSpeed();

					return (EI2cBusSpeed)System.Enum.Parse(typeof(EI2cBusSpeed), val);
				}
		...
		EI2cBusSpeed II2cBusSpeed.DefaultValue
		{
			get
			{
				try
		...
		public override object Value
		{
			get
			{
				try
				{
					return  ((II2cBusSpeed)this).Value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
			...
			set
			{
				try
				{
					((II2cBusSpeed)this).Value = (EI2cBusSpeed)value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		public override object DefaultValue
		{
			get
			{
				try
				{
					return  ((II2cBusSpeed)this).DefaultValue;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		bool II2cBusSpeed.Validate(EI2cBusSpeed value)
		{
			try
			{
		...
		public override bool Validate(object value)
		{
			try
			{
				return ((II2cBusSpeed)this).Validate((EI2cBusSpeed)value);
			}
			catch(Scotec.XMLDatabase.DataException e)
			{
				throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
