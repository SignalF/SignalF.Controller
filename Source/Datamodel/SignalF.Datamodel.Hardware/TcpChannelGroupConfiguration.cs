...
{
	public partial class TcpChannelGroupConfiguration : SignalF.Datamodel.Hardware.ChannelGroupConfiguration, SignalF.Datamodel.Hardware.ITcpChannelGroupConfiguration
	{
		#region Properties

		
		private const string IPADDRESS_PROPERTY_NAME = "IpAddress";		
		System.String ITcpChannelGroupConfiguration.IpAddress
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as ITcpChannelGroupConfigurationVisitor<TResult>;
