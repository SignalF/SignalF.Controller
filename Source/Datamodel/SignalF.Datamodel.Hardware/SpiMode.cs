...
{
	public partial class SpiMode : BusinessAttribute, SignalF.Datamodel.Hardware.ISpiMode
	{
		...
		ESpiMode ISpiMode.Value
		{
			get
			{
				try
				{
					...
					return (ESpiMode)System.Enum.Parse(typeof(ESpiMode), val);
				}
		...
		ESpiMode ISpiMode.DefaultValue
		{
			get
			{
				try
		...
		public override object Value
		{
			...
			set
			{
				try
				{
					((ISpiMode)this).Value = (ESpiMode)value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		public override object DefaultValue
		{
			get
			{
				try
				{
					return  ((ISpiMode)this).DefaultValue;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		bool ISpiMode.Validate(ESpiMode value)
		{
			try
			{
		...
		public override bool Validate(object value)
		{
			try
			{
				return ((ISpiMode)this).Validate((ESpiMode)value);
			}
			catch(Scotec.XMLDatabase.DataException e)
			{
				throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
