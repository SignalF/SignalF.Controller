...
{
	public partial class Vendor : BusinessAttribute, SignalF.Datamodel.Base.IVendor
	{
		...
		System.String IVendor.DefaultValue
		{
			get
			{
				try
		...
		public override object Value
		{
			...
			set
			{
				try
				{
					((IVendor)this).Value = (System.String)value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		public override object DefaultValue
		{
			get
			{
				try
				{
					return  ((IVendor)this).DefaultValue;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		bool IVendor.Validate(System.String value)
		{
			try
			{
		...
		public override bool Validate(object value)
		{
			try
			{
				return ((IVendor)this).Validate((System.String)value);
			}
			catch(Scotec.XMLDatabase.DataException e)
			{
				throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
