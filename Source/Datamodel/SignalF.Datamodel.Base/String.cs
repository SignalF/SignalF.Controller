...
{
	public partial class String : BusinessAttribute, SignalF.Datamodel.Base.IString
	{
		...
		System.String IString.DefaultValue
		{
			get
			{
				try
		...
		public override object Value
		{
			...
			set
			{
				try
				{
					((IString)this).Value = (System.String)value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		public override object DefaultValue
		{
			get
			{
				try
				{
					return  ((IString)this).DefaultValue;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		bool IString.Validate(System.String value)
		{
			try
			{
		...
		public override bool Validate(object value)
		{
			try
			{
				return ((IString)this).Validate((System.String)value);
			}
			catch(Scotec.XMLDatabase.DataException e)
			{
				throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
