...
{
	public partial class VoltageUnit : SignalF.Datamodel.Units.Unit, SignalF.Datamodel.Units.IVoltageUnit
	{
		#region Properties

		
		private const string UNIT_PROPERTY_NAME = "Unit";		
		Scotec.Math.Units.Voltage.Units IVoltageUnit.Unit
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as IVoltageUnitVisitor<TResult>;
