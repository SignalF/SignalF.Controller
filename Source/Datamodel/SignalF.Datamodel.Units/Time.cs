...
{
	public partial class Time : BusinessAttribute, SignalF.Datamodel.Units.ITime
	{
		...
		Scotec.Math.Units.Time.Units ITime.Value
		{
			get
			{
				try
				{
					...
					if(val.Length == 0)
						return new Scotec.Math.Units.Time.Units();

					return (Scotec.Math.Units.Time.Units)System.Enum.Parse(typeof(Scotec.Math.Units.Time.Units), val);
				}
		...
		Scotec.Math.Units.Time.Units ITime.DefaultValue
		{
			get
			{
				try
		...
		public override object Value
		{
			...
			set
			{
				try
				{
					((ITime)this).Value = (Scotec.Math.Units.Time.Units)value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		bool ITime.Validate(Scotec.Math.Units.Time.Units value)
		{
			try
			{
		...
		public override bool Validate(object value)
		{
			try
			{
				return ((ITime)this).Validate((Scotec.Math.Units.Time.Units)value);
			}
			catch(Scotec.XMLDatabase.DataException e)
			{
				throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
