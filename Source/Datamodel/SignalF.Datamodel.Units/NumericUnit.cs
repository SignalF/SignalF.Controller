...
{
	public partial class NumericUnit : SignalF.Datamodel.Units.Unit, SignalF.Datamodel.Units.INumericUnit
	{
		#region Properties

		
		private const string UNIT_PROPERTY_NAME = "Unit";		
		Scotec.Math.Units.Numeric.Units INumericUnit.Unit
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as INumericUnitVisitor<TResult>;
