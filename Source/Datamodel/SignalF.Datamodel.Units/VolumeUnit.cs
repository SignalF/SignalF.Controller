...
{
	public partial class VolumeUnit : SignalF.Datamodel.Units.Unit, SignalF.Datamodel.Units.IVolumeUnit
	{
		#region Properties

		
		private const string UNIT_PROPERTY_NAME = "Unit";		
		Scotec.Math.Units.Volume.Units IVolumeUnit.Unit
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as IVolumeUnitVisitor<TResult>;
