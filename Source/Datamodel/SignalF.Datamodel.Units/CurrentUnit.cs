...
{
	public partial class CurrentUnit : SignalF.Datamodel.Units.Unit, SignalF.Datamodel.Units.ICurrentUnit
	{
		#region Properties

		
		private const string UNIT_PROPERTY_NAME = "Unit";		
		Scotec.Math.Units.Current.Units ICurrentUnit.Unit
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as ICurrentUnitVisitor<TResult>;
