...
{
	public partial class LengthUnit : SignalF.Datamodel.Units.Unit, SignalF.Datamodel.Units.ILengthUnit
	{
		#region Properties

		
		private const string UNIT_PROPERTY_NAME = "Unit";		
		Scotec.Math.Units.Length.Units ILengthUnit.Unit
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as ILengthUnitVisitor<TResult>;
