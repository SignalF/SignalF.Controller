...
{
	public partial class AngleUnit : SignalF.Datamodel.Units.Unit, SignalF.Datamodel.Units.IAngleUnit
	{
		#region Properties

		
		private const string UNIT_PROPERTY_NAME = "Unit";		
		Scotec.Math.Units.Angle.Units IAngleUnit.Unit
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as IAngleUnitVisitor<TResult>;
