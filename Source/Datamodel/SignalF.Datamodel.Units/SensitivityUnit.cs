...
{
	public partial class SensitivityUnit : SignalF.Datamodel.Units.Unit, SignalF.Datamodel.Units.ISensitivityUnit
	{
		#region Properties

		
		private const string UNIT_PROPERTY_NAME = "Unit";		
		Scotec.Math.Units.Sensitivity.Units ISensitivityUnit.Unit
		{
			get
			{
				try
		...
		{
			var specificVisitor = visitor as ISensitivityUnitVisitor<TResult>;
