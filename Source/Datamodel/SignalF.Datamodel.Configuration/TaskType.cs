...
{
	public partial class TaskType : BusinessAttribute, SignalF.Datamodel.Configuration.ITaskType
	{
		...
		ETaskType ITaskType.Value
		{
			get
			{
				try
				{
					...
					if(val.Length == 0)
						return new ETaskType();

					return (ETaskType)System.Enum.Parse(typeof(ETaskType), val);
				}
		...
		ETaskType ITaskType.DefaultValue
		{
			get
			{
				try
		...
		public override object Value
		{
			...
			set
			{
				try
				{
					((ITaskType)this).Value = (ETaskType)value;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		public override object DefaultValue
		{
			get
			{
				try
				{
					return  ((ITaskType)this).DefaultValue;
				}
				catch(Scotec.XMLDatabase.DataException e)
				{
					throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
		...
		bool ITaskType.Validate(ETaskType value)
		{
			try
			{
		...
		public override bool Validate(object value)
		{
			try
			{
				return ((ITaskType)this).Validate((ETaskType)value);
			}
			catch(Scotec.XMLDatabase.DataException e)
			{
				throw new BusinessException((EBusinessError)e.DataError, e.Message, e);
